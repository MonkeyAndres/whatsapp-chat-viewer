...
const translations = {
  es: {
    ...
    'about.description':
      'WhatsApp Chat Viewer es una herramienta en linea para ver chats exportados de WhatsApp. La web no guarda datos de usuario: solo da formato a los mensajes para ayudar a leer chats exportados.',
    'about.requirement':
      'Para usar esta herramienta necesitas un chat exportado de WhatsApp en formato .txt. Abajo puedes ver como exportarlo.',
    'about.exportTitle': 'Como exportar un chat de WhatsApp',
    'about.exportHelp':
      'Sigue la parte "Export chat history" de los tutoriales siguientes.',
    ...
    'about.projectMiddle':
      '. Es completamente gratis y de codigo abierto. Puedes acceder al codigo fuente ',
    'about.projectLink': 'aqui.',
    'file.choose': 'Elige un archivo',
    'file.chooseOrDrop': 'Elige un archivo o arrastralo aqui',
    'contact.back': 'Volver',
    ...
    'error.unsupportedDescription':
      'No se encontraron lineas de mensajes de WhatsApp compatibles. Elige una exportacion .txt de WhatsApp sin archivos multimedia.',
    'error.readTitle': 'No pudimos leer este archivo.',
    'error.readDescription':
      'Elige de nuevo el archivo .txt exportado, o exporta una copia nueva sin archivos multimedia.',
    'error.privateDiagnostic': 'Diagnostico privado',
    'error.file': 'Archivo',
    'error.extension': 'Extension',
    'error.type': 'Tipo',
    'error.size': 'Tamano',
    'error.linesChecked': 'Lineas revisadas',
    'error.cause': 'Causa',
    'error.candidateLines': 'Lineas candidatas',
    'error.recognizedLines': 'Lineas reconocidas',
    'error.dateOrder': 'Orden de fecha',
    'error.none': 'ninguno',
    'error.recognizedFormats': 'Las lineas reconocidas se parecen a ',
    'error.or': 'o',
    ...
    'diagnostic.cause.conflict':
      'Se encontro evidencia contradictoria de dia/mes en el chat.',
